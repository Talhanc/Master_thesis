...
struct nominal_state {
    ...
    nominal_state() { gravity << 0, 0, 9.81; }
    ...
    Eigen::Vector18d nees_error(const nominal_state& other) const {
        Eigen::Vector18d vec;
    ...
    nominal_state operator-(const nominal_state& other) const {
        nominal_state diff;
